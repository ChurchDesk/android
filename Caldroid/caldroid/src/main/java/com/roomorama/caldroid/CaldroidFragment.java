...
public class CaldroidFragment extends DialogFragment {
	...
	private SimpleDateFormat monthFormatter = new SimpleDateFormat("MMMM", Locale.getDefault());
  ...
  protected boolean squareTextViewCell;
	...
	public void setBackgroundResourceForDates(
			HashMap<Calendar, Integer> backgroundForDateMap) {
   ...
   * may change on orientation change
	...
	private String getCurrentMonth(Boolean isNext) {
		firstMonthTime.year = year;
		firstMonthTime.month = isNext == null ? month - 1 : isNext ? month : month - 2;
		firstMonthTime.monthDay = 1;
		long millis = firstMonthTime.toMillis(true);
	...
	public void refreshView() {
		...
		if (mMonthChangedListener != null)
			mMonthChangedListener.onChanged(getCurrentMonth(null));
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		leftArrowButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				prevMonth();
				if (mMonthChangedListener != null) {
					mMonthChangedListener.onChanged(getCurrentMonth(false));
				}
			}
		});
		...
		rightArrowButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				nextMonth();
				if (mMonthChangedListener != null) {
					mMonthChangedListener.onChanged(getCurrentMonth(true));
				}
			}
		});
	...
	public void setMonthChangedListener(OnMonthChangedListener monthChangedListener) {
		this.mMonthChangedListener = monthChangedListener;
	}
