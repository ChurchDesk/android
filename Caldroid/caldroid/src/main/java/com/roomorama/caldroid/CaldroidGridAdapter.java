...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    private void populateFromCaldroidData() {
        disableDates = (List<DateTime>) caldroidData
        ...
        selectedDates = (Set<DateTime>) caldroidData
...
//        cellView.setBackgroundResource(R.drawable.white_clickable);
        ...
        if (dateTime.getMonth() != month) {
            cellView.setTextColor(resources
                    .getColor(R.color.grey_text_light));
        }
...
//            cellView.setBackgroundResource(CaldroidFragment.selectedBackgroundDrawable);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            cellView = (RelativeLayout) inflater.inflate(R.layout.square_date_cell, null);
        } else {
            cellView = (RelativeLayout) convertView;
        }

        TextView tv = (TextView) cellView.findViewById(R.id.calendar_tv);
        ImageView iv = (ImageView) cellView.findViewById(R.id.focused_tv);

        customizeTextView(position, tv, iv);
